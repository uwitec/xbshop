...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?act=store_order&op=change_state&state_type=edit_amount_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
    ...
    <dl>
      <dt><?php echo '总额'.$lang['nc_colon'];?></dt>
      <dd>
