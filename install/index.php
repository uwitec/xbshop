...
$html_footer = <<<EOF
<div class="footer">
  <h6><a href="http://" target="_blank">程序来源于 </a></h6>
</div>
EOF;
...
function step3(&$install_error,&$install_recover){
    ...
    if ($_POST['demo_data'] == '1'){
        $db->query("UPDATE {$db_prefix}store SET `live_store_name`='俏江南',`live_store_address`='天津市南开区南门外大街2号大悦城购物中心北区4L-27',`live_store_tel`='022-87288577',`live_store_bus`='829路、832路、837路、855路、841路、860路 地铁2号线' WHERE `store_id`=1");
