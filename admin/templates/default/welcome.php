  ...
  <div class="info-panel">
    ...
    <dl class="system">
      <dt>
        ...
        <div id="system-info">
          <ul>
            <li>校帮 <?php echo $lang['dashboard_welcome_version'];?><span><?php echo $output['statistics']['shop_version'];?></span></li>
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="http://" target="_blank">官方网站<sub></sub></a></li>
          <li class="w50pre none"><a href="http://" target="_blank">官方论坛<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
