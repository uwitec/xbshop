...
function submit_delete(id){
    if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
        ...
        $('#list_form').attr('action','index.php?act=cms_navigation&op=cms_navigation_drop');
        $('#navigation_id').val(id);
        $('#list_form').submit();
    }
}
</script>
    ...
    <table class="table tb-type2">
      <thead>
        ...
        <tr class="thead">
          ...
          <th class="align-left"><?php echo $lang['cms_navigation_name'];?></th>
          <th class="align-left"><?php echo $lang['cms_navigation_url'];?></th>
          <th class="align-left"><?php echo $lang['cms_navigation_open_type'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w48"><input type="checkbox" value="<?php echo $val['navigation_id'];?>" class="checkitem"></td>
          <td class="w48 sort"><span nc_type="navigation_sort" column_id="<?php echo $val['navigation_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val['navigation_sort'];?></span>
          ...
          <td class="w72 align-center"><a href="javascript:submit_delete(<?php echo $val['navigation_id'];?>)"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
